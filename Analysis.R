...
#Step 2
# harvest some tweets
some_tweets = searchTwitter("Independence Day Resurgence", n=10000, lang="en")
...
# Step 5 Plots the obtained result
...
#Step 6 Separate the text by emoticons and visualize the words with the comparison cloud
